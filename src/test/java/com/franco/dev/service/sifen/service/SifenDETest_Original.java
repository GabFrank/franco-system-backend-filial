...
/**
 * CLASE ORIGINAL - NO MODIFICAR
 * Esta es una copia del test proporcionado por la librería SIFEN.
 * Se mantiene como referencia para verificar la estructura correcta de los datos.
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("dev")
public class SifenDETest_Original {

    private static final Logger logger = LoggerFactory.getLogger(SifenDETest_Original.class);

    @Test
    @Transactional
    @Commit
    public void testRecepcionDE() throws SifenException {
        logger.info("=== INICIANDO TEST DE RECEPCIÓN DE DE INDIVIDUAL (ORIGINAL) ===");
        ...
        logger.info("=== TEST DE RECEPCIÓN DE DE INDIVIDUAL (ORIGINAL) COMPLETADO ===");
    }
    ...
    public void testConsultaDE() throws SifenException {
        logger.info("=== INICIANDO TEST DE CONSULTA DE DE (ORIGINAL) ===");
        ...
        logger.info("=== TEST DE CONSULTA DE DE (ORIGINAL) COMPLETADO ===");
    }
    ...
    public void testRecepcionLoteDE() throws SifenException {
        logger.info("=== INICIANDO TEST DE RECEPCIÓN DE LOTE DE (ORIGINAL) ===");
        ...
        logger.info("=== TEST DE RECEPCIÓN DE LOTE DE (ORIGINAL) COMPLETADO ===");
    }
    ...
    public void testConsultaLoteDe() throws SifenException {
        logger.info("=== INICIANDO TEST DE CONSULTA DE LOTE DE (ORIGINAL) ===");
        
        String protocoloLote = "109051592123784"; // <--- CAMBIAR ESTE PROTOCOLO
        
        RespuestaConsultaLoteDE ret = Sifen.consultaLoteDE(protocoloLote);
        logger.info("Respuesta de consulta lote DE: {}", ret.toString());
        
        logger.info("=== TEST DE CONSULTA DE LOTE DE (ORIGINAL) COMPLETADO ===");
    }
    ...
    public void testRecepcionEvento() throws SifenException {
        logger.info("=== INICIANDO TEST DE RECEPCIÓN DE EVENTO (ORIGINAL) ===");
        ...
        logger.info("=== TEST DE RECEPCIÓN DE EVENTO (ORIGINAL) COMPLETADO ===");
    }
