...
/**
 * Test para generar URL QR y compararla con la existente en la base de datos.
 * Este test utiliza datos reales del documento electrónico ID = 35.
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("dev")
@TestPropertySource(properties = {
    "sifen.enabled=false" // Deshabilitar SIFEN para este test
})
public class SifenServiceQrTest {

    private static final Logger log = LoggerFactory.getLogger(SifenServiceQrTest.class);
    ...
    private FacturaLegal crearFacturaLegalConDatosReales() {
        ...
        facturaLegal.setFecha(LocalDateTime.of(2025, 9, 22, 16, 2, 17)); // 2025-09-22T16:02:17
    ...
    /**
     * Test adicional para verificar la codificación de fecha
     */
    @Test
    @Transactional
    @Commit
    void testCodificacionFecha() {
        ...
        LocalDateTime fecha = LocalDateTime.of(2025, 9, 22, 16, 2, 17);
